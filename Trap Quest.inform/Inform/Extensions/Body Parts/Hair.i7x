...
@!]
hair is a body part.  hair is everywhere.  The description of hair is "[TotalDesc of hair]".  Understand "my hair" as hair.
...
To say 2HairDesc (X - a number):
	if the player is not prone:
		...
		if X is 15, say "straight [HairSoak][HairColour] [HairStyle] that is so long it touches the ground when you [if the player is upright]are standing[otherwise]bounce your way[end if]";
		if X > 15, say "straight [HairSoak][HairColour] [HairStyle] that is so long it collects and drags along the ground as you [movementDesc]";
	otherwise:
		if X is 1, say "incredibly short, [HairSoak][HairColour] army style hair";
		if X is 2, say "[if the player is male]standard, short [HairSoak][HairColour] hair[otherwise]tomboyish [HairSoak][HairColour] hair[end if]";
		if X is 3, say "straight [HairSoak][HairColour] [HairStyle] that reaches the tops of your ears";
...
To HairUp (X - a number):
	...
	otherwise:
		...
		if hair-fail is 0 or hair-fail is 1:
			...
			if the largeness of hair is 3, say "You feel your hair significantly grow! [one of][first custom style]This can't be a good sign...[or][if the bimbo of the player < 12][first custom style]Here we go again...[otherwise]That felt goood...[end if][stopping][roman type][line break]";
			if the largeness of hair is 4, say "You feel your hair significantly grow! [one of][first custom style]So this game is going to make my hair grow really long?[or][if the bimbo of the player < 12][first custom style]A bearable size for now...[otherwise]Yay, my hair does need to be longer![end if][stopping][roman type][line break]";
			if the largeness of hair is 5 and the player is male, say "You feel your hair grow until it reaches your chin. [one of][if the bimbo of the player < 7][first custom style]This hair is starting to feel very girly...[otherwise][second custom style]I guess this hair length isn't too bad.[end if][or][stopping][roman type][line break]";
			if the largeness of hair is 5 and the player is female, say "You feel your hair grow until it reaches your chin. [one of][if the bimbo of the player < 5][first custom style]I always cut my hair before it gets this long...[otherwise][second custom style]I know I usually cut my hair before it gets this long, but I guess this length isn't too bad.[end if][or][stopping][roman type][line break]";
			if the largeness of hair is 6 and the player is male, say "You feel your hair grow until it reaches your shoulders. [one of][if the bimbo of the player < 8][first custom style]Ugh, this is definitely girl's hair now.[otherwise][second custom style]It could be worse, I don't mind having this length hair I guess...[end if][or][stopping][roman type][line break]";
			if the largeness of hair is 6 and the player is female, say "You feel your hair grow until it reaches your shoulders. [one of][if the bimbo of the player < 6][first custom style]Ugh, this hair is definitely too 'pretty girl' for me now.[otherwise][second custom style]This hair length is totally fine, I am a girl after all.[end if][or][stopping][roman type][line break]";
			if the largeness of hair is 7 and the player is male, say "You watch your hair grow until it reaches nipple level. [one of][if the bimbo of the player < 8][first custom style]They're just trying to make me feel like a girl.  I've got to fight it![otherwise][second custom style]There's something nice about having long flowing locks of hair...[end if][or][stopping][roman type][line break]";
			if the largeness of hair is 7 and the player is female, say "You watch your hair grow until it reaches nipple level. [one of][if the bimbo of the player < 6][first custom style]They're just trying to make me feel more comfortable accepting all the girly stereotypes.  I've got to fight it![otherwise][second custom style]There's something nice about having long flowing locks of hair...[end if][or][stopping][roman type][line break]";
			if the largeness of hair is 8, say "You watch your hair grow until it reaches elbow level. [one of][if the bimbo of the player < 8][first custom style]How much more can it grow?![otherwise][second custom style]How much more can it grow, I wonder?[end if][or][second custom style][if the bimbo of the player > 12]I think I just love long hair...[end if][stopping][roman type][line break]";
			if the largeness of hair is 9, say "You watch your hair grow until it reaches your belly button. [if the player is not prone]You can feel it behind you tickling the small of your back. [end if][one of][if the bimbo of the player < 9][first custom style]This is getting silly now.[otherwise][second custom style]Ooh, it just keeps going, doesn't it?[end if][or][stopping][roman type][line break]";
			if the largeness of hair is 10, say "You watch your hair grow until it reaches your crotch. [if the thickness of hips > 6 and the player is not prone]You feel the hair start to bunch up and settle on top of your [HipDesc]. [end if][one of][if the bimbo of the player < 10][first custom style]Not only do I now look like some kind of sheltered maiden, but if it grows much further I'll end up tripping over it![otherwise][second custom style]I feel like some kind of glamorous model![end if][or][stopping][roman type][line break]";
			if the largeness of hair is 11, say "Your hair continues to grow right in front of your eyes, until it reaches your [ShortDesc of thighs]. [if the semen coating of thighs > 2 and the player is upright]It starts to stick to the [semen] on the insides of your [ShortDesc of thighs]. [end if][if the thickness of hips > 5 and the player is not prone]Behind you, it flows gracefully over your [HipDesc]. [end if][one of][if the sex addiction of the player < 10 and the semen coating of thighs > 2][first custom style]Oh man, that's just gross.  And I have to walk around like this?[otherwise if the bimbo of the player < 10][first custom style]My hair is so long it's making my head feel awkwardly heavy![otherwise][second custom style]I wish I could see myself in a mirror, I bet my hair looks amazing![end if][or][stopping][roman type][line break]";
			if the largeness of hair is 12, say "Your hair continues to grow right in front of your eyes, until it reaches your knees. [if the thickness of hips > 5 and the player is not prone]You feel it continue to flow over your [HipDesc]. [end if][one of][if the bimbo of the player < 12][first custom style]Please stop growing now...[otherwise][second custom style]I have the best hair in the world![end if][or][if the bimbo of the player > 12][second custom style]This is the perfect hair length, I think.[end if][stopping][roman type][line break]";
			if the largeness of hair is 13, say "Your hair continues to grow right in front of your eyes, until it reaches your calves. [one of][if the bimbo of the player < 12][first custom style]If it grows any more, I'm definitely going to have trouble walking...[otherwise][second custom style]Why wouldn't I want it to grow longer?[end if][or][stopping][roman type][line break]";
			if the largeness of hair is 14, say "Your hair continues to grow right in front of your eyes, until it reaches your ankles! [one of][if the bimbo of the player < 12][first custom style]Fuck this, now I'm basically tripping over my hair![otherwise][second custom style]Whoops!  My hair is so long, I'd better take care not to trip on it![end if][or][stopping][roman type][line break]";
			if the largeness of hair is 15, say "Your hair grows even further, and now touches the floor! [one of][if the bimbo of the player < 12][first custom style]How am I supposed to walk around like this...[otherwise][second custom style]Wow, my hair is crazily long![end if][or][stopping][roman type][line break]";
			if the largeness of hair > 15, say "Your hair grows even further, and [one of]now starts[or]continues[stopping] to collect on the floor! [one of][if the bimbo of the player < 13][first custom style]Fuck me... my hair is insane.[otherwise]Whoops!  There it goes, still growing even longer...[second custom style][end if][or][variable custom style]They should call me Rapunzel![or][stopping][roman type][line break]";
		let P be a random off-stage pink scrunchie;
		if P is actually summonable and 0 is the number of worn headgear and there are 2 off-stage pink scrunchie and (hair-fail > 0 or the raw largeness of hair >= 14):
			...
			summon P cursed;
		otherwise if a random number between 1 and 250 is 1 and P is actually summonable and there is a worn pink scrunchie and (hair-fail > 0 or the raw largeness of hair >= 14):
