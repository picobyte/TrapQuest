...
Carry out direct-presenting something to:[TODO: make this less humiliating for a princess]
	...
	if the noun is face:
		...
		if the humiliation of the player < 12500, say "[one of][first custom style]I can hardly believe what I'm doing!  How degrading...[roman type][line break][or][stopping]";
	...
	otherwise if the noun is breasts:
		...
		say "[one of][variable custom style]I'm advertising my tits as just another place on my body for men to fuck...  [if the humiliation of the player < 12500][first custom style]How awfully shameful.[end if][roman type][line break][or][stopping]";
		now the the player-reaction of the player is submitting;
	...
	otherwise if the noun is vagina:
		...
		if the humiliation of the player < 12500, say "[one of][first custom style]Oh my god, how humiliating is this!  What am I becoming...[roman type][line break][or][stopping]";
		now the the player-reaction of the player is submitting;
		now presented-orifice is vagina;
		humiliate 300;
		let T be a random no-regrets tattoo;
		if there is a worn tattoo and the humiliation of the player < 25000 and the sex addiction of the player < 11 and T is not worn:
			summon T;
	...
	otherwise if the noun is asshole:
		...
		if the humiliation of the player < 12500, say "[one of][first custom style]Oh my god, how humiliating is this!  What am I becoming...[roman type][line break][stopping]";
		now the the player-reaction of the player is submitting;
		now presented-orifice is asshole;
		let T be a random just the tip tattoo;
		if there is a worn tattoo and the humiliation of the player < 15000 and T is not worn and the second noun is unfriendly:
			summon T;
			say "Your skin stings as a tattoo is suddenly seared into your butt cheek!  It says 'Just the Tip'.";
		unless there is a worn just the tip tattoo, humiliate 350;
...
To say FriendlyOralRequest of (M - a monster):
	...
	otherwise:
		say "[if the oral sex addiction of the player < 4][first custom style]'I'm not going to enjoy it, but I need you to let me pleasure you with my mouth, okay?'[otherwise if the sex addiction of the player < 10][variable custom style]'[one of]I... I don't usually ask people this, but please can I serve you with my mouth?'[or]I think it would be a good idea if I make you happy with my tongue, if you'd like that?'[stopping][otherwise][variable custom style]'[one of]Hey sugar, I've got a great idea of how to pass the time!'[or]Hey, I know what we should do, it'll be fun!'[or]Want to find out how skilled I am with my tongue?'[in random order][end if][roman type][line break]".
...
To say AnalRequestFlav of (M - a monster):
	if the player is not able to speak or M is not intelligent or the humiliation of the player > 15000 or the sex addiction of the player > 9, say "You spread your ass cheeks and [asshole] wide and wiggle your hips, trying to signal that [if the second noun is friendly]you'd really enjoy getting ass-fucked right now[otherwise if the humiliation of the player < 40000 and the sex addiction of the player < 11 and the player is male]you're consenting to getting fucked in the [asshole][otherwise if the humiliation of the player < 40000 and the anal sex addiction of the player > the vaginal sex addiction of the player]you'd rather get fucked in the [asshole] than your [vagina][otherwise]you're ready to have your [asshole] used[end if].".
