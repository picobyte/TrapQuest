...
Check quaffing:
	...
	if the player is wrist bound in front and there are worn heels and the player is not prone and the noun is not held by the player, say "With your hands tied together you won't be able to balance well enough to pick that up without getting on your knees." instead;
...
Carry out quaffing:
	now seconds is 3;
	StomachUp 1;
	if the noun is cursed, say "That tasted really awful - you're pretty sure it was cursed!";
	destroy the noun.
