...
This is the lack of genitalia rule:
	if the size of penis is 0 and the player is male:
		...
		rule fails.
The lack of genitalia rule is listed last in the masturbation restriction rules.
...
This is the embarrassing masturbation rule:
	...
	if asshole is actually occupied:
		if the anal sex addiction of the player + the sex addiction of the player < 5:
			if (the player is male and the player is not horny) or the player is not a bit horny:
				say "You can[']t bring yourself to masturbate when there[']s [if the number of monsters penetrating asshole > 0]someone fucking[otherwise]something in[end if] your [asshole]!";
				rule fails;[Female players are more open to masturbating with toys.]
			if the player is not very horny and (the humiliation of the player / 10000) < the number of monsters in the location of the player:[shouldn't ever trigger when the player is alone]
				if M is monster:
					say "You can't bring yourself to [if the player is male]jack off[otherwise]finger yourself[end if] now. What if the [printed name of M] thinks you actually like [if the number of monsters penetrating asshole > 0]getting fucked in the[otherwise]having things up your[end if] ass!";
					rule fails;
	if the number of monsters penetrating vagina > 0:
		if the vaginal sex addiction of the player + the sex addiction of the player < 5:
			if the player is not horny and (the humiliation of the player / 10000) < the number of monsters in the location of the player:
				if M is monster:
					say "You can't bring yourself to touch yourself now. What if the [printed name of M] thinks you actually like getting fucked?";
					rule fails;
	if the number of monsters penetrating face > 0:
		if the semen addiction of the player + the sex addiction of the player < 5:
			if the player is not horny and (the humiliation of the player / 10000) < the number of monsters in the location of the player:
				if M is monster:
					say "You can't bring yourself to touch yourself now. What if the [printed name of M] thinks you actually like sucking dick?";
					rule fails.
