...
Check entering gloryhole:
	...
	[Let's also make the milking the default action if they have milky breasts and no dick]
		if the milk volume of breasts > 0 and bottom level lactation cover is nothing:
			...
			say "You feel a tongue probe at your sexless mound, and suddenly freeze...  [variable custom style]'What the fuck?  You're some kind of doll, aren't you!'[roman type]  You hear a woman sniffing.   [variable custom style]'Hah!  This'll teach you to poke your nose where you shouldn't!'[roman type][line break]You hear a lever pulled, nearby, and suddenly two holes open up, just at your breast height!";
...
To compute gloryhole blowjob receipt:
	...
	if a random number between 1 and 3 is 1 and the size of penis > 1 and face is not actually occupied:
		...
		say "You gasp in shock as a black hole appears in the portrait next to your face, and [one of]a strangely familiar [ShortDesc of penis] is forced into your mouth!  As the [player-penis] pushes past your lips, you feel a pair of lips move around your own.  Then, as your tongue touches the base of the [player-penis], you feel a tongue touch the base of your own.  [variable custom style]Wait a minute... I'm sucking my own [player-penis]!  How [if the bimbo of the player < 9]awful[otherwise if the bimbo of the player < 13]weird[otherwise]cool[end if]![roman type][line break][or]your [player-penis] once again enters your own mouth.  [stopping]You [if the bimbo of the player < 10]can't help but [end if]moan as your own mouth starts to stimulate you, and [one of][if the sex addiction of the player < 8]since the magic of the gloryhole clearly isn't going to let you go until you've finished[otherwise]unable to resist the pleasure[end if],[or]once again[stopping] you [if the sex addiction of the player < 8]reluctantly [end if]get to work.";
		say "[variable custom style]How weird is this!  [roman type][if the sex addiction of the player < 8]But although you start off reluctantly sucking your own [player-penis], you're soon telling yourself that it's not so much you're sucking a dick, as you've just found a new way to wank, right?  [variable custom style]I mean, how different is this to those guys who are so flexible they can bend over and suck their own dicks?  It's not like this is training me to enjoy sucking dicks, ha ha!  [roman type][otherwise]It doesn't take long, though, before you're really getting into this!  It's like having the perfect blowjob partner: you can imagine your [player-penis] is being swallowed whole by some hot bitch who can magically read your mind to know exactly what you'd like done at any instant.  [variable custom style]Mmm, like that![roman type]  You wrap your tongue around the tip, rasping it up against the sensitive underside, and feel your balls throb in reaction.  [variable custom style]Yeah, bitch, just like that![roman type]  You hum, making your [player-penis] vibrate deliciously.  You suck harder, and feel more blood rush into the fleshy rod jabbing into your mouth, stiffening it even further.  [variable custom style]Wow, sucking dicks is fun![roman type]  You start to really get into the sensation of the silken-smooth, stiff staff thrusting into your mouth.[end if]";
		...
		otherwise if the size of the penis < 8:
			say "The [player-penis] pushes against the back of your throat, and you suddenly feel the urge to see if you can deep throat it!  Eagerly, you angle your head so it slides deep into your gullet.  For a moment you start to gag, but since you're in total control of every movement, it's not too scary or threatening, and you find you're able to relax your throat without much effort.  And then you really start to get into it.  [variable custom style]Yeah, go bitch, swallow that sword![roman type][line break]";
		otherwise:
...
To compute gloryhole painting blowjob:
	...
	say GloryHoleSuction;
	say "You watch in [if the oral sex addiction of the player < 3]horror[otherwise if the oral sex addiction of the player < 6]shock[otherwise]awe[end if] as the large [manly-penis] in the painting in front of you slowly comes to life, sealing your [LipDesc] around it as it [if the oral sex addiction of the player < 12]forces[otherwise]pushes[end if] them apart.  The penis thrusts in and out of your mouth, the bottom half phasing in and out of the painting like some bizarre hologram.";
	now gloryhole is penetrating face.
...
To compute gloryhole genital modification:
	...
	if there is a worn tattoo and the number of worn crotch tattoos is 0:
		...
		summon T;
		say "You feel a sharp pain near your crotch and pull your body back.  You now have a 'SLUT' tattoo!  [variable custom style][if the bimbo of the player < 13]Fuck![otherwise]Heh.  It's making me feel even more [one of]girly[or]giddy[at random]![end if][roman type][line break]";
...
To say SexResistFlav of (G - gloryhole):
	if the player is not upright:
		...
		otherwise:
			say "You shuffle backwards, removing the [manly-penis] from you mouth and giving the anonymous man blue balls.  [first custom style]'[one of]Fucking bitch!  Come back here!'[or]What the fuck?  You've got to be shitting me!'[or]Hey [bitch], I wasn't finished!'[or]You fucking [slut]!  Finish sucking my cock you little [bitch]!'[in random order][roman type][line break]He doesn't seem happy, but after a few seconds the [manly-penis] is removed from the hole.";
			dislodge G;
	otherwise if G is normal glory hole:
		say "You try to pull away but the magical suction is holding you tightly against the wall[if the sex addiction of the player < 8 and the oral sex addiction of the player < 5][one of]!  You can't even pull your eyes away from the large painting of the cock in front of your face[or][or][or][or][or][cycling][end if]!";
				...
				if the player is male:
					...
					otherwise if (the player is extremely horny and the turns trapped of gloryhole > 1) or (the player is very horny and the turns trapped of gloryhole > 3) or the turns trapped of gloryhole > 5 or the size of penis < 3:
						...
						if the size of the penis is 0:
							say "You feel a tongue probe at your sexless mound, and it suddenly freezes...  [variable custom style]'Stupid fucking sex dolls,'[roman type] you hear a woman mutter.   [variable custom style]'Well, maybe this'll teach it to poke its nose where it shouldn't!'[roman type][line break]";
						...
						otherwise if the size of the penis is 1:
							...
							say "For several seconds, nothing happens.  Then you feel a tongue flick past the end of your [player-penis].  It freezes, then slowly slides down, tracing a line directly below it, probing at the place where your ball-sac [italic type]used[roman type] to be.  You hear a woman giggle.  [variable custom style]'You poor sod, I really thought some bitch had shoved her vag up here for a lapping, but you're actually a guy, aren't you?  Normally I'd have no chance of reaching your tiny nubbin, but the Nintendolls R&D department planned for this unlikely event.  Hang on...'[roman type]  You feel her tongue withdraw, then something oily and circular presses forwards against your mostly-smooth mound, and suddenly a powerful humming starts and the suction increases ten-fold!  You feel your tiny clitoris swell and bulge, almost painfully.  It reminds you of what your erections [italic type]used[roman type] to feel like.  At least, until the girl snorts in disbelief.  [variable custom style]'Wow, that's much bigger now - it must be the size of a cigarette butt!  Looks pretty red though, babe - I hope your tender little raspberry isn't going to burst!'[roman type] ";
							humiliate 400;
						otherwise:
						...
						if tinyDickGrabbed is 1:
							say "But even though it felt [italic type]wonderful[roman type], you stare in shock at the tiny amount you squirted out.  [variable custom style]I doubt any chick would even FEEL that, if I squirted in her[roman type]  Then realise, there's no way you could work your little clit inside [italic type]anyone[roman type]!  But the device is still sucking, as if it doesn't realise you're already finished, and you stare in a kind of sick fascination at your groin as your nubbin swells and shrinks with each suck.  [variable custom style]It won't really burst, will it?[roman type]  Your [player-penis] bulges, flushing a darkening, angry red - but because of the suction, and its tiny length, it's now as wide as it is long!  It really [italic type]does[roman type] look like a raspberry.  [variable custom style]Or maybe, a strawberry, if I'm being generous?[roman type]  It deepens in colour to a dark purple, and it's really starting to hurt... but finally, the suction ends, and the device hisses as air rushes in, and pops free.[line break]";
