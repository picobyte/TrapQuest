...
Check wearing a slimegirl:
	say "You can't wear that!" instead.

Check taking off a slimegirl:
	say "[if the noun is worn]She's inside you, that's not very straightforward...[otherwise]How would that work?[end if]" instead.

Check inserting a slimegirl into:
...
A slimegirl has a number called timetaken.
[
	...
	if there is a worn slimegirl:
		...
		if the timetaken of M > a random number between (200 - (hunger of M * 10)) and 250:
			...
			otherwise if the hunger of M < 5:
				...
				if R is 2:
					say "You feel the [M] significantly influencing your love of [semen] and sex.";
					now the intensity of M is 2;
				if R is 3:
					if weight gain fetish is 1:
						say "You feel the [M] enlarging your ass cheeks, to make you more tempting to potential partners.";
						AssSwell 1;
					otherwise:
			...
			otherwise if the hunger of M < 7:
				...
				if R is 2:
					if the hunger of M is 7:
						say "You feel the [M] forcing your mind to think like a total anal slut.";
			...
			otherwise if the hunger of M < 10:
				...
				if a random number between 1 and 2 is 1:
					say "You feel the [M] expanding your breasts!";
					BustUp 1;
				otherwise:
...
To compute talk option (N - 2) to (M - a slimegirl):
...
To compute talk option (N - 3) to (M - a slimegirl):
	if M is worn:
		if the hunger of M < 3:
			if lactation fetish is 1:
...
To compute talk option (N - 4) to (M - a slimegirl):
	if M is worn:
		if the hunger of M < 3:
