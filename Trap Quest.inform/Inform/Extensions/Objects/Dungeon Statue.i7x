...
To say DungeonScenery01Desc:
	if diaper quest is 0:
		...
		say "A statue of a naked man with a ridiculously sized [if the bimbo of the player > 13][second custom style]but yummy looking[roman type] [end if][manly-penis].  There seems to be a hollow tube inside the [manly-penis] with an exit at the tip.";
	otherwise:
		if images visible is 1, display figure of DungeonScenery01d;
		say "A line of bronze women with their big bare butts pointing towards you.  They look weirdly... spankable.";
		if newbie tips is 1, say "[one of][item style]Newbie tip: These statues can be spanked, reducing your overall diaper addiction but slightly increasing delicateness in return.  If your addiction to diapers gets too high, you can come here to resolve the issue.[or][stopping]".

To say DungeonScenery01bDesc:
	if diaper quest is 0:
		if images visible is 1, display figure of DungeonScenery01;
		say "Your eyes are drawn to a particular statue of one of the naked men with the largest of the already ridiculously sized [if the bimbo of the player > 13][second custom style]but yummy looking[roman type] [end if]penises.  [one of]On closer inspection you notice a hole at the tip of the [manly-penis] of the statue... there's a hollow tube inside![or]There seems to be a hollow tube inside the [manly-penis] with an exit at the tip.[stopping]";
	otherwise:
		say "[DungeonScenery01Desc]".

Definition: DungeonScenery01 (called I) is immune to change:
	decide yes.
...
Carry out whacking:
	say "You thwack the butt of one of the ladies[one of] with all your might[or][stopping].  [variable custom style]Ow!!![roman type]  You feel the spank on your own [buttcheeks]!  That hurt[if the raw diaper addiction of the player > 1 and the raw delicateness of the player < 20], but you feel like it has brought you to your senses a little[end if].";
	if the raw delicateness of the player < 20, DiaperAddictDown 2;
	DelicateUp 1.
