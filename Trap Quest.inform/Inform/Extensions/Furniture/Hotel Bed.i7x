...
To compute rest ending of (F - HotelBedCreamy):
	...
	otherwise if bukkake fetish is 1:
		...
		say "[if the semen addiction of the player < 6][first custom style]Ewww!  How fucking gross.  I need to clean up now![otherwise if the semen addiction of the player < 10][variable custom style]I feel all slippery and weird![otherwise if the semen addiction of the player < 15][variable custom style]Ooh, it's all so sticky and thick!  I wonder whose it is...[otherwise if the semen taste addiction of the player < the semen addiction of the player][second custom style]Oh yay, stranger's cum all over me, I couldn't have wished for a better treat![otherwise][second custom style]Oh yay, stranger's cum all over me, I couldn't have wished for a better treat!  I can't wait to taste it.[end if][roman type][line break]";
...
To compute PatronSpawning of (F - HotelBedPatrons):
	...
	if R > 2, say "[if the sex addiction of the player < 9][variable custom style]Oh crap, that's way too many...[otherwise if the sex addiction of the player < 15][variable custom style]I hope I can please them all...[otherwise][second custom style]Ooh yay!  The more the merrier![end if][roman type][line break]";
