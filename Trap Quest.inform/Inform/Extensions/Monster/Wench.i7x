...
A wench is a kind of monster.  A wench is usually dungeon dwelling.  A wench is usually intelligent.  A wench is usually raunchy.  A wench is usually willing to do oral.  A wench has a number called suffocation.  The wench has a number called guard-obedience. The leftover-type of a wench is usually 102. A wench is usually wenchy.

The printed name of wench is usually "[if item described is in the location of the player][TQlink of item described][end if][input-style][monster-adjective of item described] wench[if the sleep of the item described > 0] (fast asleep)[end if][shortcut-desc][roman type][if item described is in the location of the player][TQxlink of item described][verb-desc of item described][end if]".  The description of wench is usually "[WenchDesc]".  
...
A desperate wench is a kind of wench.  There is 1 desperate wench.  The text-shortcut of desperate wench is "dwe".
...
A frantic wench is a kind of wench.  There is 1 frantic wench.  The text-shortcut of frantic wench is "fwe".
...
To say WenchDesc:
	if images visible is 1:
		if item described is desperate wench or item described is frantic wench:
	...
	otherwise if the variety of the item described is 1:
		if the faint count of the player is 0:
			say "This woman is completely naked and plastered with [semen]. If the purple bruises on her wrists, ankles, and neck are any indication, she's probably spent most of her time here cooped up in chains. Her skin is [one of]pale[or]a pale brown[sticky random], and her [one of]brown[or]blonde[or]black[sticky random] hair is unkempt and messy. She wears a look on her face that says 'Please don't hurt me', and the [semen] freely dribbling out of both her holes and [if the number of knickers retained by the item described > 0]soaking through her stolen [printed name of a random knickers retained by the item described][otherwise]down her legs[end if] gives a pretty good idea what she has to do when she makes that request. All things considered, she's actually quite attractive.";
		otherwise:
			say "This woman is [if the number of knickers retained by the item described > 0]almost[end if]completely naked and plastered with [semen]. The freshest stuff is dribbling down her thighs from within her[if the number of knickers retained by the item described > 0] stolen [printed name of a random knickers retained by the item described][otherwise] gaping twat[end if] and slightly distended belly. The look of fear and confusion on her pale face tells you that she has probably been repeatedly creampied against her will, recently too. She has [one of]mousy brown[or]straight blonde[or]frizzy black[sticky random] hair and a tattoo across the small of her back that reads 'PROPERTY'. Despite that, she'd actually be pretty attractive if she were a bit cleaner.";
	otherwise if the variety of item described is 2:
		if the faint count of the player is 0:
			say "This woman is plastered with cum from head to toe and [if the number of knickers retained by the item described > 0]wearing a pair of stolen [printed name of a random knickers retained by the item described] and a pink blouse, both of which are as soaked as she is[otherwise]completely naked except for a pink blouse, which is just as soaked as she is[end if]. Her lips are caked with a mixture of smudged [one of]gold[or]red[or]pink[or]purple[sticky random] lipstick and [semen], and her eyes are framed by runny, streaked eye shadow. She has [one of]pale brown[or]pale white[sticky random] skin, a [one of]mousy brown[or]messy blonde[or]frizzy black[sticky random] ponytail, and a look on her face that says 'Please don't hurt me!'. She's actually quite attractive, all things considered.";
		otherwise:
			say "This woman's [one of]mousy brown[or]straight blonde[or]frizzy black[sticky random] hair is caked with dried [semen], much like the rest of her body. She is completely naked except for a cum coated pink blouse[if the number of knickers retained by the item described > 0]and a pair of stolen [printed name of a random knickers retained by the item described],[otherwise],[end if] with a nest of hatch marks on her [one of]pale[or]light brown[sticky random] inner thighs which make it obvious she's been around here for a very long time. Her pussy is slick with fresh [semen], which is plastered to her inner thighs and asscrack. If she were a little cleaner, and didn't seem to wear a face of fear and confusion at all times, she'd actually be pretty attractive.";
	otherwise:
		if the faint count of the player is 0:
			say "This woman is wearing a black blouse, which looks like it was pulled open rather roughly to expose her [one of]A cup[or]B cup[or]C cup[or]D cup[or]DD cup[sticky random] breasts. She is [if the number of knickers retained by the item described > 0]also wearing a pair of stolen [printed name of a random knickers retained by the item described], which is already messy from the pearly white ejaculate covering her from head to toe.[otherwise]otherwise completely naked, leaving you sure that there isn't an inch of her body that isn't plastered with pearly white ejaculate.[end if] In fact, if there's a clean part of her body, it's her face, which is caked with heavy makeup that's been smudged in only a few places. She has [one of]pale brown[or]pale white[sticky random] skin, a [one of]mousy brown[or]messy blonde[or]frizzy black[sticky random] ponytail, and a look on her face that says 'Please don't hurt me!'. If she were a bit cleaner, she'd be quite attractive.";
		otherwise:
			say "This woman is completely naked except for a loose black blouse and [if the number of knickers retained by the item described > 0]a pair of stolen [printed name of a random knickers retained by the item described], both of which are thoroughly soaked with the [semen] covering her whole body.[otherwise]plastered with [semen].[end if] The fact that some of it is still dribbling out of both of her holes and down her legs tells you that she has been repeatedly used and abused, probably [one of]sometime within the last few minutes![or]moments ago![or]against her will.[or]without her consent.[purely at random] She has [one of]mousy brown[or]messy blonde[or]frizzy black[sticky random] hair and [one of]pale brown[or]pale, nearly white[sticky random] skin, as though she has been deprived of sunlight for a very long time. She's actually quite attractive, which makes it easy for you to understand why she looks so scared, confused, and exhausted.";
	say " [variable custom style][if the bimbo of the player < 5 and the player is male][one of]Man, I'd fuck the shit out of that chick! Looks like somebody already beat me to it though...[or]She's hot, but I don't like sloppy seconds.[stopping][otherwise if the bimbo of the player < 5][one of]Oh god, what happened to this woman? Is that going to happen to me?[or]So that's how women are treated here. Disgusting.[stopping][otherwise if the bimbo of the player < 8][one of]She looks like she hasn't had any real food to eat in months. I'd probably win any fight with her.[or]She looks pretty weak. I could probably beat her in a fight if I needed to.[in random order][otherwise if the bimbo of the player < 11][one of]Thinking of what happened to her to make her that messy is so exciting. I should probably stop...[or]Am I going to end up like that? Doesn't seem that bad, really.[or]She looks like she could really use some clothes.[in random order][otherwise if pregnancy fetish is 1]Hee hee, I bet she'll get pregnant from having all that cum in her pussy.[otherwise if the bimbo of the player < 14][one of]She looks like she's had a lot of fun here.[or]Look at all that yummy cum![in random order][otherwise][one of]Maybe she's another player. If I help her get out, maybe she'll fuck me as a reward![or]She looks like she knows how to PARTY![stopping][end if][roman type][line break]".
...
To set up (M - a wench):
	...
	if M is frantic wench or M is desperate wench, now the variety of M is 5;
	otherwise now the variety of M is a random number between 1 and 3.

This is the spawn initial wench rule:
	if debugmode > 1, say "Now summoning wench.";
	if diaper quest is 1:
		repeat with M running through wenches:
			now M is not dungeon dwelling;
	otherwise if the number of alive wenches is 0:
...
To say SummoningFlav of (M - a wench):
	if M is in the location of the player:[TODO: diaper quest]
		say "A space opens up in the centre of the circle, and a single hand forces its way through! You watch as a naked woman claws her way out of the grasp of whatever is on the other side of the portal [if M is desperate wench or M is frantic wench]moaning uncontrollably[otherwise][one of]whimpering[or]shivering[or]holding back a moan[at random][end if] as she rips [one of]a tentacle out of her pussy[or]a muscular arm away from her crotch[at random] and staggers to her feet. The dark energy dissipates as the portal closes up.";
	otherwise:
		if M is desperate wench or M is frantic wench, say "You hear the sound of involuntary moaning coming from another part of the dungeon.";
...
To compute perception of (M - a wench):
	...
	if the latex-transformation of the player > 6: [TODO maybe variety 4 wenches can have sex with male doll?]
		say "She seems a [if M is desperate wench or M is frantic wench]bit aroused but[otherwise]little creeped out by your appearance and[end if] leaves you alone.";
		bore M;
	otherwise if M is desperate wench or M is frantic wench:
	...
	otherwise if M is objectifying the player:
		...
		otherwise:
			if the previous-objectification of M is 0, say "Something seems to change in the way the [M] is looking at you.  [speech style of M]'We should fuck.'[roman type][line break]";
	...
	otherwise if the variety of M < 4 and there are held desirable knickers and the number of knickers retained by M is 0:
		...
		if M is buddy:
			say "[speech style of M]'I'm very jealous of your [ShortDesc of K][speech style of M]. [if M is ally]Where did you get it?'[otherwise]You should hide that when I'm around otherwise I might just have to fight you for it!  Ha ha...'[end if][roman type][line break]";
			FavourDown M;
		...
		otherwise:
			...
			anger M;
			now the sex-length of M is 2;
			say "[speech style of M]'... that [ShortDesc of K][speech style of M]... where did you get it?  Give it to me!'[roman type][line break]";
	otherwise:
		compute appearance assessment of M;
	if image cutscenes is 1, display interaction of M.

To display interaction of (M - a wench):
	if M is desperate wench or M is frantic wench:
...
To compute kneeling reaction of (M - a wench):
	if the guard-obedience of M is 0:
		...
		if there are desirable knickers and the variety of M < 4:
			say "[speech style of M]'Drop your panties on the ground or I'll rip them off you, bitch.  Unless you'd rather [bold type]offer[speech style of M] me your tongue.'[roman type][line break]";
		otherwise:
			if M is frantic wench or M is desperate wench:
...
To say waitingflav of (M - a wench):
	if there are worn desirable knickers and M is not desperate wench and M is not frantic wench:
		...
		if the guard-obedience of current-monster is 1:
			...
			otherwise:
				...
				otherwise if M is penetrating face:
					say "[one of]The [current-monster] kneels next to you, holding her mouth open, allowing the [M] to fuck your mouth and hers alternately[or][speech style of M]'You!  Fuck my cock with her mouth.'[roman type]  The [current-monster] obeys, holding your head and forcing it back and forth like a living onahole.[line break][if M is able to make sounds][variable custom style][muffled sounds][roman type][line break][end if]You choke and splutter[at random].";
				...
				otherwise:
					say "[one of]The [current-monster] kisses the [M] passionately, slapping your [BreastDesc] roughly as she does for good measure, purposefully hurting you.[or][speech style of M]'You!  Slap her while I fuck her.  HARD.'[roman type]  The [current-monster] looks at you and hesitates for only a brief moment, before bringing her hand powerfully across your cheek.  It stings painfully![in random order]";
					DelicateUp 1;
		otherwise:
			say "The [random royal guard in the location of the player] yells angrily.  [first custom style]'NO CAT-FIGHTING!  [one of]GET ON THE GROUND NOW, WENCHES[or]Assume the position, and I will administer your punishment[or]DOWN ON THE GROUND, [if the number of wenches in the location of the player > 1]ALL[otherwise]BOTH[end if] OF YOU[in random order]!'[roman type][line break]";
...
To reset submissive wenches:
	repeat with N running through awake wenches in the location of the player:
		if the number of royal guards penetrating a body part is 0 and the guard-obedience of N is 1:
			...
			say "[if N is unfriendly][speech style of N]'[one of]You got lucky this time, [bitch][or]I'll get you next time, [bitch][or]I'll be back for you later[in random order].'[roman type] [end if]The [N] starts to crawl away.";
			bore N;
	...
	repeat with N running through awake adult baby slaves in the location of the player:
		if the number of spanking the player royal guards is 0 and the guard-obedience of N is 1:
			if the health of N >= the maxhealth of N, calm N;
			say "[if N is unfriendly][speech style of N]'[one of]You got lucky this time, [bitch][or]I'll [']play['] with you next time we meet, [bitch][or]We'll finish this later[in random order].'[roman type] [end if]The [N] starts to crawl away.";
			bore N;
			now the guard-obedience of N is 0;
...
To compute facial climax of (M - a wench):
	...
	say "You hear a sigh and then a moan and then a screaming orgasm come from the [M].  Her own sex juices flood [if the reaction of the player > 0]into your mouth[otherwise]onto your face[end if].[if the semen taste addiction of the player > 12][second custom style]Mmm, tasty!  [roman type][end if]She continues screaming in pleasure for a few seconds, then you feel her hold on your body weaken, and she rolls off your body, passed out from the pleasure.";
...
This is the wench steals clothing rule:
	...
	if there is a desirable knickers and M is not desperate wench and M is not frantic wench and the number of clothing retained by M is 0 and the player is prone:
		ClothingSteal M;
		rule succeeds.
...
This is the wench monster fucked taunting rule:
	...
	let M be current-monster;
	if P is wench:
		if there are desirable knickers and M is not desperate wench and M is not frantic wench:
			ClothingSteal M;
		otherwise:
			...
			now the fainting reason of the player is 9;
			rule succeeds;
	otherwise if M is not desperate wench and M is not frantic wench:
...
This is the wench monster convinced rule:
	...
	if presented-orifice is face:
		say "[if M is not desperate wench and M is not frantic wench]The [M] sees your request and grins.  [speech style of M]'Haha, okay, you asked for it, here I come!'[otherwise]The [M] sees your request and smiles.  [speech style of M]'I knew you would see things my way!'[end if][roman type][line break]";
		now the chosen-orifice of current-monster is face;
		rule succeeds;
	otherwise if presented-orifice is not nothing:
		say "[if M is not desperate wench and M is not frantic wench]The [M] sees your request and shakes her head.  [speech style of M]'If I'm going to fuck you, I'll be using your mouth!'[otherwise]The [M] sees your request and frowns.  [speech style of M]'Did you not hear what I said?  I need you to lick me out!'[end if][roman type][line break]".
...
To say MouthPenetrationFlav of (M - a wench):
	if M is desperate wench or M is frantic wench or M is friendly-fucking:
		say "She buries your nose into her cum-dripping asshole and covers your mouth with her cum-filled [vagina].  You can't breathe![line break][speech style of M]'[one of]Please lick it all out of me!'[or]I really need to feel your tongue...'[or]Don't worry, it tastes really good!'[purely at random][roman type][line break]";
	otherwise:
...
To say StrikingFlav of (M - a wench) on (B - a body part):
	say "The [M] slaps you [TargetName of B]![if M is not desperate wench and M is not frantic wench]  [speech style of M]'[one of]Bitch[or]Slut[or]Whore[or]Fucker[or]Fuck you[in random order]!!'[roman type][line break][end if]".
	...
	if the health of M > 0:
		if the sleep of M is 0:
			if M is uninterested:
				say "The girl looks shocked.  [speech style of M]'[one of]Fucking bitch!  Come on then![or]What the fuck is your problem?  You're going down!'[or]Oh you are going to wish you never messed with me!'[at random][roman type][line break]";
				now M is interested;
				anger M;
				now the sex-length of M is 2;	
			otherwise:
...
To compute unique death of (M - a wench):
	...
	if the health of M <= 0:
		let O be nothing;
		if the variety of M is 2 and M is not desperate wench and M is not frantic wench, now O is a random off-stage unique pink bodice;
		otherwise now O is a random off-stage unique black bodice;
		if O is bodice and the variety of M > 1 or M is desperate wench or M is frantic wench:
			now O is in the location of the player;						
			if M is desperate wench or M is frantic wench, now the semen-soak of O is 10;
			otherwise now the semen-soak of O is a random number between 6 and 10;
...
To say angry punishment clothing destruction of (M - a wench) on (C - a clothing):
	if M is intelligent, say "[first custom style]'Let's see how YOU like walking around with your [if C is nipple covering and the largeness of breasts > 3]tits out!'[otherwise if C is ass covering][fuckholes] on display!'[otherwise]body on display!'[end if][roman type][line break]".

To say angry punishment accessory confiscation of (M - a wench):
	if M is intelligent, say "[first custom style]'I'll just even it out by keeping this!'[roman type][line break]".

To say DominanceSuccess of (M - a wench):[TODO: eventual penetration]
	if the size of penis > 8:
		if player is a bit horny:
			say "The [M] takes one look at your rock hard [ShortDesc of penis] and tries to scramble away, but you grab her by the hair and force her down onto her knees. [first custom style]'Where you goin['] bitch? I thought you liked drinking cum.'[roman type] She shakes her head vigorously, but you don't take no for an answer, grinding your swollen erection up against her face until she finally opens her mouth. You revel in the sound of her gagging as you shove it in, brutally fucking her face until she seems to remember what her place is. She does most of the work from there, stroking the underside of your shaft with her tongue as she pumps your [manly-penis] from the base and fondles your balls.";
			Dignify 20;[Extra dignity when you save up]
		otherwise:
			say "You force the [M] to her knees. [if the times-dominated of M > 0]She's avoids eye contact as she guides your [manly-penis] into your mouth, skilfully fondling your balls and teasing her nipples as your [ShortDesc of penis] quickly reaches its full size[otherwise]She lazily opens her mouth, staring at your [manly-penis] and fondling her breasts as she robotically licks her lips. However, as your [ShortDesc of penis] slowly approaches its full size, her expression changes to one of fear, and she clamps her mouth shut as your erection nears her lips. Unfortunately you're not taking no for an answer, slapping her cheeks with your rock hard [manly-penis] until she finally gives up, avoiding eye contact as she obediently guides it into her mouth[end if]. You spend some time fucking her face to make sure she remembers what her place is, but after that you're fine letting her do the work for a while, smirking down at her as she dutifully polishes the underside of your shaft with her tongue.";
		if the player is desperate to pee and watersports fetish is 1:
			say "You never said you'd make it easy for her though, and without warning you suddenly jam her down and start peeing straight down her throat! She struggles at first, but after a couple of moments she just accepts it, staring up at you submissively as your hot [urine] settles in her belly. You shove her off and nut on her face when you're finished done.";
			now the bladder of the player is 0;
			Dignify 65;
		otherwise:
			say "Its pretty hard to deny that she does a great job, [if the oral sex addiction of the player > 3 and the throatskill of the player is 0]in fact, you're actually a little jealous of her technique[otherwise if the oral sex addiction of the player > 3]in fact, you can't help feeling she might actually be even better than you are[otherwise]but you're still getting the feeling that she isn't really making use of her full potential[end if]. You make sure she has to put her skills to good use, forcing her to keep at least 7 inches in her mouth at once, and holding her wrists above her head so she can't cheat by using her hands. [if M is desperate wench]She has a lot of trouble focusing on the exercise[otherwise]Its clear she's no master at doing things without the training wheels on[end if], but by the time your load spurts down her throat, she's learned a whole lot about how to properly [one of]service[or]gag on[or]please[at random] your [ShortDesc of penis]. You shove her off without waiting for her to finish, allowing the rest of your [semen] to splatter liberally across her face and breast.";
			Dignify 50;
		orgasm;
		say "[AfterDominationComment 5 of M]";
	otherwise if the size of penis > 6 and the player is a bit horny:
		say "You force the [M] to her knees, brandishing your fully erect [ShortDesc of penis]. [variable custom style]'[if the player is desperate to pee and watersports fetish is 1]So, want something to drink, bitch[otherwise]So, I heard you like drinking cum, bitch[end if]?'[roman type] [if the times-dominated of M > 0]She nods quickly[otherwise]She gulps, avoiding eye contact as she answers with a slow nod[end if], gripping the base of your shaft with one hand and lightly stroking it as she drags her tongue up your length. You didn[']t really come here for foreplay though, and just as you're ready to 'nudge' her into beginning the main event, her lips wrap themselves around the end of your [manly-penis] and immediately glide down your spit-coated shaft. She furrows her eyebrows as your tip brushes the back of her throat, bracing her hands on your thighs as she forces herself down even further.";
		if the player is desperate to pee and watersports fetish is 1:
...
To oral dominate (M - a wench):[TODO: update]
	...
	if the player is male:
		say "You force the [M] onto her back, sitting on her face. [if the bimbo of the player < 12][first custom style]'[one of]No offence meant[or]Nothing personal[at random], I promise.'  [otherwise][second custom style]'Let's see how you like it!'  [end if][roman type]Pulling your asscheeks apart, you position your [asshole] over her mouth, scooting back slightly to cut off airflow to her nose. She whines petulantly, trying to squirm away, failing because she is weak from the preceding fight. Reluctantly, she opens her mouth and begins to massage your sphincter with her tongue. ";
...
To say AfterDominationComment (N - a number) of (M - a wench):
	if N is 0, say "[second custom style]'[one of]You can dominate me any time, baby.'[or]Hey, maybe you can be on top again next time.'[or]I'm glad I let you dominate me, that was fun!'[in random order][roman type][line break]";
	if N is 1, say "[second custom style]'[one of]I'll be on top next time.'[or]It's going to be me on top next time.'[or]It's going to be MY genitals in YOUR face next time.'[in random order][roman type][line break]";
	if N is 2, say "[second custom style]'[one of]You better hope that shrimpy thing is bigger next time you see me.'[or]I hope you remember how that felt, because I'm going to fucking punish you next time, baby dick.'[or]Don't think this is ever going to happen again. Not when you have a tiny baby dick like that.'[in random order][roman type][line break]";
	if N is 3, say "[second custom style]'[one of]Ooh, you-! I'll fucking get you for that!'[or]Don't think I won't make you pay for that, baby dick.'[or]You're going to pay for that next time, baby dick.'[in random order][roman type][line break]";
	if N is 4, say "[second custom style]'[one of]I'll get you for that, fucker!'[or]You won't get away with that, fucker!'[or]I'll make you pay for that, fucker.'[in random order][roman type][line break]";
	if N is 5, say "[second custom style]'[one of]Asshole...'[or]Will you leave me alone now? I don[']t like doing this you know.'[or]Don[']t think you[']re gonna get away with this forever, asshole.'[in random order][roman type][line break]";
...
To compute (M - a wench) considering (T - a vessel):
	...
	otherwise:
		say "The [M] shakes her head no. [speech style of M]'What would I even fill it up with?'[roman type]".
		
To decide which number is the blue-balls-limit of (M - a desperate wench):
	decide on -4.
...
To compute annoyance of (M - a wench):
	...
	otherwise if M is unfriendly:
		say "The wench ignores your question.  [speech style of M]'Shut up and help me out!'[roman type][line break]";
	otherwise:
...
To say WhereAnswer of (M - a wench):
	say "[speech style of M]'Some terrible dungeon filled with traps and monsters!  Everything seems built to fuck you or turn you into a slut.'[roman type][line break]".
...
To say StoryAnswer of (M - a wench):
	say "[speech style of M]'[one of]I got very drunk at an office party, woke up, and here I was! Am I dreaming? Am I dead? Is this hell?'[or]I took home a development copy of this dumb game to play from my personal capsule at home, and I'm stuck here because of a stupid glitch... has nobody realized I'm missing yet?!'[or]I bit off more than I could chew in a game of poker. Now I'm in here.'[or]I was trying to hack this game so I could play it in godmode, but I fucked something up, and now I'm trapped.'[or]I took a job bug testing because I needed some money, but I can't remember how to get out.'[or]I walked through a magic wardrobe and ended up in this world! I'm trying to find my way out and back to my normal life.'[as decreasingly likely outcomes][roman type][line break]".

To say EscapeAnswer of (M - a wench):
	say "[speech style of M]'[one of]No fucking idea...'[or]Do you think I'd still be here if I knew?'[or]I don't know at all. I tried to ask a guard but he wouldn't talk to me.'[or]I get my ass kicked as soon as I try to go anywhere. I have no idea.'[at random][roman type][line break]".
...
To decide which number is the bartering value of (T - a desirable knickers) for (M - a wench):
	if M is desperate wench or M is frantic wench, decide on 0;
	decide on 4.
