...
An adult baby slave is a kind of monster. an adult baby slave is usually intelligent. an adult baby slave is usually raunchy. an adult baby slave is usually willing to do oral. an adult baby slave is usually unwilling to do anal. An adult baby slave has a number called suffocation. an adult baby slave has a number called ToMatron. The favour of adult baby slave is usually 10.  An adult baby slave has a number called guard-obedience.  The leftover-type of an adult baby slave is usually 123. 
 
The printed name of adult baby slave is usually "[if item described is in the location of the player][TQlink of item described][end if][input-style][monster-adjective of item described] adult baby slave[if the sleep of the item described > 0] (fast asleep)[end if][shortcut-desc][roman type][if item described is in the location of the player][TQxlink of item described][verb-desc of item described][end if]". The description of adult baby slave is usually "[ABSDesc]". 
Figure of AABS is the file "AABS.png". Figure of BABS is the file "BABS.png".

An angelic adult baby slave is a kind of adult baby slave. there is 1 angelic adult baby slave.  An angelic adult baby slave is usually dungeon dwelling. 
...
A bratty adult baby slave is a kind of adult baby slave. there is 1 bratty adult baby slave.  A bratty adult baby slave is usually hotel dwelling. 
The printed name of bratty adult baby slave is usually "[if item described is in the location of the player][TQlink of item described][end if][input-style]bratty adult baby slave[if the sleep of the item described > 0] (fast asleep)[end if][shortcut-desc][roman type][if item described is in the location of the player][TQxlink of item described][verb-desc of item described][end if]". understand "brat" as bratty adult baby slave.  The text-shortcut of bratty adult baby slave is "bbs". 
...
To say ABSDesc:
	if images visible is 1:
		if item described is angelic adult baby slave:
			display the Figure of AABS; 
		if item described is bratty adult baby slave:
...
To set up (M - an adult baby slave):
	...
	now the variety of M is a random number between 1 and 2.

This is the spawn initial dungeon adult baby slave rule:
	if the number of angelic adult baby slaves in the dungeon is 0 and diaper lover >= 1:
		if debugmode > 0, say "Summoning adult baby slave in dungeon.";
		let M be a random adult baby slave;
...
This is the spawn initial hotel adult baby slave rule:
	if the number of bratty adult baby slaves in the hotel is 0 and diaper lover >= 1:
		if debugmode > 0, say "Summoning adult baby slave in hotel.";
		let M be a random bratty adult baby slave;
		summon M in the hotel.
The spawn initial hotel adult baby slave rule is listed in the setting up hotel monsters rules.

Definition: an adult baby slave (called M) is human:
	decide yes.
	
Part 1 - Misc Flavour

To say SummoningFlav of (M - an adult baby slave):
	say "You hear childish giggling coming from another part of the [if the player is in the dungeon]dungeon[otherwise]hotel[end if].".
	
To say DiaperReaction of (M - an adult baby slave):
	if M is unfriendly:
		say "The [M] slaps your diapered ass as you wet yourself.[speech style of M]'[if M is penetrating a body part][one of]Once I'm done playing with you, you should probably go to a Daddy or Mommy for a change unless you like sitting in your wet diapers. I do.'[or]Having you pee your diaper while I sit on your face is really turning me on... You don't have to do anything else, do you?'[or]You peeing your diaper while I sit on your face with mine is making me pretty horny.'[at random][otherwise if the player is not prone]You really should have let me know if we were gonna take a pee break.'[otherwise]It's nice to see that I'm in good company, piddle-pants.'[end if][roman type][line break]";
	otherwise:
		say "The [M] smiles gently and pats your back. [speech style of M]'[one of]Don[']t feel bad about wetting your diaper. It means that you're more like me.'[or]Doesn't it feel really good to flood your diaper? I love the warm, wet squish!'[or]If we go ask mommy, maybe she'll change us into each others diapers... Would you want to wear my wet diaper?'[at random][roman type][line break]";
	if the humiliation of the player < 15000, say "[variable custom style][if the player is able to speak]'Wait! I swear I don[']t normally do that!'[otherwise]I can[']t even try to explain myself...[end if][roman type][line break]";
...
To compute diaper mess reaction of (M - an adult baby slave):
	if M is unfriendly:
		if M is bratty adult baby slave, say "The [M] slaps your diapered ass as you mess yourself, spreading your mess around while it's still coming out of you.[speech style of M]'[if M is penetrating a body part][one of]You made all that fuss and you still went in your pants? Guess you're just drooling and babbling away, from being like the other babies around here. You were all just talk!'[or]Watching you make such a big, mushy mess in your huggies is making me really horny!'[or]Ohhh, I know you could only feel it, but watching your dignity drain out of you to swell your diaper was just a sight! You know what I'm going to do now right? It's ok, you'll learn to love it!'[roman type][line break]As the musk of soiled diaper furrows into your nostrils, the slave's unnecessarily evil giggle fills the room, her victory punctuated by her childish bouncing and mocking tune, the song of your helpless subservience to her infantile wants![line break][speech style of M]'Just let it happen cutie, your smelly load tells me how badly you want this!'[roman type][line break]You panic as the reality of the situation sets in. Your body grows heavy as you struggle desperately for just one gasp of fresh air as the adult baby's filthy diaper takes dominion of your senses.[at random][otherwise if the player is not prone]Awww, you know how long it's been since I had a 69 diaper soiling? You say you're a big girl but you're a selfish one!'[otherwise]How does it feel being dominated by a dirty diaper slave, are you embarrassed?'[end if][roman type][line break]";
		otherwise say "The [M] slaps your diapered ass as you mess yourself, spreading your mess around while it's still coming out of you.[speech style of M]'[if M is penetrating a body part][one of]Once I'm done playing with you, you should probably go to mommy for a change unless you like sitting in your dirty diapers... I do but mommy says that only the biggest babies like playing in their own messes...'[or]Watching you make such a big, mushy mess in your huggies is making me really horny!'[or]That's not fair! If you told me you had to mess, we could have gone at the same time! Still... Is it weird that I think your dirty diaper smells really good?'[roman type][line break]The adult baby slave shoves her face in your messy diaper, adopting a 69 position.[line break][speech style of M]'But better late than never, right?'[roman type][line break]You panic at her insinuation as she fills her diaper with a load of warm mush on your face, causing you to gag at the scent of her mess as she continues to nuzzle and caress your own.[at random][otherwise if the player is not prone]Hey! You should have told me you needed to mess yourself! I might have let you sit on my face...'[otherwise]'How does it feel knowing that you're as big a baby as I am?[end if][roman type][line break]";
		humiliate 400;
	otherwise: [###Selkie: “Kimberly”, not [PlayerName]?]
		if M is bratty adult baby slave, say "The [M] smiles gently and pats your back. [speech style of M]'[one of]Ewww, did you just soil your diaper? I thought you were a big girl! Maybe if you beg I'll change you...in exchange for some playtime!'[or]How did you manage to stinky your diaper before me? I'd be back in big girl panties WAY before you..if I wanted them anyway!'[or]Kimberly made a stiiinky~! Kimberly made a stiiinky~! Wait until I tell mama what you did!'[or]Ohhhh, so THAT's what it means to be a big girl, you make even bigger dirty diapers!'[or]sniff sniff PU! I think I found the dirty diaper culprit!'[at random][roman type][line break]";
...
To compute MasturbationReaction of (M - an adult baby slave):
	say "The [M] watches you with a naughty expression.";
...
To compute BabyChairReaction of (M - an adult baby slave):
	say "The [M] looks at you and giggles.  [speech style of M]'[one of]Someone's trying way too hard to become teacher's pet!'[or]You want praise just for sitting on a chair?  You're even more attention seeking than me!'[or]Did you sit on the babytalk seat?  You big fat idiot!'[at random][roman type][line break]";
	Humiliate 50.
...
To compute (M - a monster) stomping (N - an adult baby slave):
	if M is in the location of the player, say "The [N] screams as she sees the [M].  The [M] picks up the [N] with two hands and hugs her tight.  [He of M] is so big that she disappears behind his arms!  As soon as she is out of sight, you hear her begin to scream.  Moments later the [M] lets her go, revealing that she is now... exactly the same?  The [M]'s screams have turned to giggles.  [second custom style]'That was fun!  Again, again!'[roman type] The [M] seems confused, and bonks her on the head with one carefully measured blow.  The [M] sighs softly and wets herself as she is knocked out.";
	otherwise say "You hear the sound of a girl screaming in terror from [if N is nearby]nearby![otherwise]somewhere in the dungeon![end if]";
	destroy N;
...
To say DiaperCheckResultsDryWellDoneFlav of (M - an adult baby slave):
	say "[speech style of M]'[one of]Oh how boring, you haven't used it at all!  Come on, surely you've got something in there that you can let out?  For me?'[or]This can't be right, you feel completely dry!  Are you sure you need diapers?'[or]Boo!  You know the whole point of diapers it to make them nice and big and [if diaper lover >= 3]smelly[otherwise]soggy[end if], right?'[in random order][roman type][line break]".
...
To compute perception of (M - an adult baby slave):
	...
	otherwise if there is a worn waddle diaper and M is friendly:
		say "She looks you up and down and smiles.[speech style of M]'Wow! I'm so jealous of your waddle diaper! I should ask mommy to put me in one!'[roman type][line break]";
		FavourUp M by 2;
	otherwise if there is a worn rocking horse diaper and M is friendly:
		say "She looks you up and down and smiles.[speech style of M]'Hi! Your horsie diaper is adorable!'[roman type][line break]";
		FavourUp M by 1;
	...
	otherwise if there is a worn baby pattern diaper and M is friendly:
		say "She looks you up and down and smiles.[speech style of M]'Your baby diaper is adorable! It makes you look just like a real baby!'[roman type][line break]";
		FavourUp M by 1;
	otherwise if there is a worn diaper and M is friendly:
		say "She looks you up and down and smiles.[speech style of M]'Hey! Cute diaper!'[roman type][line break]";
	otherwise if M is friendly:
		say "[speech style of M]'Hi!'[roman type][line break]";
	otherwise:
		say "[speech style of M]'I have an idea of what we could do together.  [if the player is not prone]PLAY FIGHT[otherwise]Stay right there[end if]!'[roman type][line break]".
	
	
To say BecomesBoredFlav of (M - an adult baby slave):
	say "[speech style of M]'I'm gonna go play somewhere else, [']kay? Bye!'[roman type][line break]Without another word, the [M] gets down on her hands and knees and goes to crawl away.".
	
Part 3 - Protection

To compute (M - an adult baby slave) protecting against (X - a monster):
	if X is adult baby slave:
		say "[speech style of M]'Don[']t hurt my friend!'[roman type][line break]The [M] yells out at your attacker.";
		distract M;
	otherwise:
		say "[speech style of M]'Sorry...'[roman type][line break]The [M] quickly crawls away, abandoning you.";
...
To say GroundPeeReaction of (M - a bratty adult baby slave):
	if M is friendly or M is uninterested:
		...
		if the player is not prone and the ToMatron of M is 1:
			anger M;
		if the player is prone and the ToMatron of M is 1: 
		...
		if the guard-obedience of current-monster is 1:
			...
			otherwise:
				...
				if a random number between 1 and 3 is 1:
					say "The [current-monster] [one of]submissively[or]diligently[or]quietly[or]obediently[at random] nuzzles [his of current-monster] cheek against the [M]'s shoulder.";
				otherwise if face is not actually occupied and a random number between 1 and 3 is 1:
					say "The [current-monster] kneels in front of you and plants an apologetic kiss [if the delicateness of the player < 7]on your cheek[otherwise]on your lips[end if].  You [if the delicateness of the player < 9]frown with humiliation[otherwise if the delicateness of the player < 13]blush, turning a pale shade of pink, your brain struggling to compute the combination of the pain in your [buttcheeks] and the loving tenderness of the [current-monster] at the same time[otherwise]find yourself returning the kiss, turning pink with shy embarrassment as you do[end if].";
					humiliate 50;
				otherwise:
					say "[one of]The [M] barks an order.  [speech style of M]'You!  Spank her at the same time as me.'[roman type]  The [current-monster] looks at you and hesitates for only a brief moment, before bringing [his of current-monster] hand powerfully across your [buttcheeks].  It stings painfully![or]The [current-monster] giggles, slapping your [buttcheeks] roughly as [he of current-monster] does, purposefully hurting you.[or]The [current-monster] laughs with glee.  [speech style of current-monster]'Yes, yes!  She started it!  Spank her harder!'[line break][speech style of M]'Silence!'[roman type] The [M] sounds angry at [him of current-monster], but does as [he of current-monster] says, dealing even more brutal slap to your [buttcheeks].[then at random]";
					DelicateUp 1;
		otherwise:
			say "The [random royal guard in the location of the player] yells angrily.  [first custom style]'NO CAT-FIGHTING!  [one of]GET ON THE GROUND NOW, BABIES[or]Assume the position, and I will administer your punishment[or]DOWN ON THE GROUND, [if the number of adult baby slaves in the location of the player > 1]ALL[otherwise]BOTH[end if] OF YOU[in random order]!'[roman type][line break]";
...
This is the adult baby slave shows you to mommy rule: 
	...
	if N is monster and the ToMatron of M is 1 and the player is in the hotel:
		...
		if the player is not in the target-room of M:
			say "[one of][second custom style]'We're gonna go see mommy!'[roman type][line break][or][stopping]";
...
To compute (M - an adult baby slave) entering mouth:
	...
	otherwise:
		...
		otherwise:
			say "The [M] [one of]begins[or]is[stopping] trying to tickle you into submission, causing you to laugh hysterically!";
...
To compute facial sex of (M - an adult baby slave):
	...
	if the body soreness of the player + the suffocation of M >= 17:
		say "The [M] continues to grind against your face you with her diapered crotch.  [one of]You really need to breathe soon!  You are so exhausted there is nothing you can do, you struggle weakly but the plastic coat of her padding is completely preventing you from breathing.  [or][stopping]";
...
To compute facial climax of (M - an adult baby slave):
	...
	say "A screaming orgasm overcomes the [M]. You feel her cum squirt into her diaper, followed by a [if diaper lover > 2]loud squelching sound as she empties her bladder and bowels against your face. The scent is overwhelming and you can literally feel the warm mush against your face[otherwise]long hissing sound as she empties her bladder against your face. The scent of pee is overwhelming[end if]. Once she's done, a yawn leaves her lips and she rolls over, sticking her thumb into her mouth and closing her eyes.[line break][speech style of M]'Ni-ni...'[roman type][line break]";
...
To compute (M - an adult baby slave) entering asshole:
	...
	otherwise:
		say "The [M] looked like she was about to do something, but then she stopped because she realised that you haven't enabled the right fetish.  This shouldn't have happened, please report the bug!";
		bore M.

This is the adult baby slave monster convinced rule:
	let M be current-monster;
	if presented-orifice is face:
		say "The [M] sees your request and smiles brightly.  [speech style of M]'Yay! I would've used your face either way but it makes me really happy that you want to too!'[roman type][line break]";
		now the chosen-orifice of current-monster is face;
		rule succeeds;
	if presented-orifice is asshole and diaper lover >= 4 and rectum > 0 and (the number of worn knickers is 0 or panty messing is 1):
		say "The [M] sees your request and grins.  [speech style of M]'Mmm, Okay... I think I have something in mind.'[roman type][line break]";
		now the chosen-orifice of current-monster is asshole;
		rule succeeds;
	otherwise if presented-orifice is not nothing:
		say "The [M] sees your request and shakes her head.  [speech style of M]'Mmmm.... Nuh uh!'[roman type][line break]".
...
To compute the orifice choosing of (M - an adult baby slave):
	if asshole is an actual target and diaper lover >= 4 and the number of worn knickers is 0 and a random number between 1 and 4 > 1:
...
To say StrikingFlav of (M - an adult baby slave) on (B - a body part):
	say "The [M] slaps you [TargetName of B]![speech style of M]'[one of]Just lie down, meanie!'[or]Stop being such a stupidhead!'[or]You're such a dumbie!'[or]Stop!'[in random order][roman type][line break]".
...
Definition: an adult baby slave (called M) is diaper disciplining:
	decide yes.

Definition: an adult baby slave (called M) is willing to deliver enemas:
	decide yes.
...
To say EnemaStartFlav of (M - an adult baby slave):
	say "The [M] pulls [sex-length of M] full enema syringes [EnemaSpace of M], with an almost insane look of glee on [his of M] face.".
...
Definition: an adult baby slave (called M) is willing to masturbate:
	decide yes.

To say MasturbationDeclarationFlav of (M - an adult baby slave):
	if there is a worn diaper, say "[speech style of M]'[one of]Let's feel really good together!'[or]I know something that you'll definitely find fun...'[at random][roman type]  ".

To say MasturbationStartFlav of (M - an adult baby slave):
	say "The [M] flips you onto your back and sits on your tummy.".
...
To say DiaperChangeStart of (M - an adult baby slave):
	say "[speech style of M]'[if there is a worn diaper]Don't you know it's bad for your health to spend too long in a used diaper?[otherwise]I think it's quite important that you wear a diaper.[end if]'[roman type]  The [M] pushes you onto your back, and pulls your legs up into the air in a classic diaper changing position.".
	...
	if the health of M > 0:
		if the sleep of M is 0:
			if M is uninterested:
				say "The girl looks shocked.  [speech style of M]'[one of]Hey!  I'll tell mommy on you![or]Stop!  That hurts!'[or]I'm gonna make you pay for this!'[at random][roman type][line break]";
				now M is interested;
				anger M;
				now the sex-length of M is 3;	
			otherwise:
...
To compute unique death of (M - an adult baby slave):
	...
	if D is a thing:
		...
		say "Her body disappears, leaving behind a [printed name of D].";
...
To IdentifiablePosterReaction of (M - an adult baby slave):
	say "The [M] looks at you, blinks, then looks back to the poster.  Upon realising that the person in the poster is you, she starts smiles seductively in your direction.[line break][speech style of M]'You know, you look pretty cute up there.'[roman type]";
...
To compute talk option (N - 1) to (M - an adult baby slave):
	...
	otherwise if there is a monster penetrating a fuckhole:
		if a random monster penetrating a fuckhole is unfriendly, say "[midDominanceGreeting of M]"; [is the player currently being fucked by another monster?]
...
To say SubmissiveGreeting of (M - an adult baby slave):
	if the diaper addiction of the player < 13:
		say "[second custom style]'Oh god... Please don't use your diaper on my face again.'[roman type][line break]";
	otherwise:
		say "'[second custom style]Hey... Wanna sit your cute, diapered ass on my face again?'[roman type][line break]".
	
To say DominantResponse of (M - an adult baby slave):
	if M is friendly:
...
To say ToDominantGreeting of (M - an adult baby slave):
	if the bimbo of the player < 8:
		say "[first custom style]'Mmf!'[roman type][line break]";
	otherwise:
		say "[first custom style]'Mmm...Mm-Hmm!'[roman type][line break]".

To say AsDominantResponse of (M - an adult baby slave):
	say "[second custom style]'[one of]Your face feels amazing against my diaper!'[or]I think I'm gonna pee!'[or]How does my diaper taste?'[or]You're making an awful lot of noise down there, baby.'[or]It feels really good when you muffle against my diaper!'[at random][roman type][line break]".

To say midDominanceGreeting of (M - an adult baby slave):
	if the sex addiction of the player < 10:
		say "[first custom style]'Help me!'[roman type][line break]";
	otherwise:
		say "[first custom style]'Hey! Wanna take off that diaper and join us?'[roman type][line break]".

To say midDominanceResponse of (M - an adult baby slave):
...
To compute annoyance of (M - an adult baby slave):
	...
	otherwise if M is unfriendly:
		say "The adult baby slave ignores your question.  [speech style of M]'No!'[roman type][line break]";
	otherwise:
