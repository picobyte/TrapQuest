...
To say BimboGreet:
	...
	otherwise if M is a monster:
		...
		otherwise if M is intelligent and the player is a sissy and the delicateness of the player > the bimbo of the player and the player is not prone and there is worn knee-length or shorter clothing:
			let H be 0;
