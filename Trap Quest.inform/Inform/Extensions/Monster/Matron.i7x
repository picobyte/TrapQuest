...
A matron is a kind of monster.  A matron is usually intelligent.  A matron is usually female.  The difficulty of a matron is usually 9.  [A matron is usually hotel dwelling.]  There is 1 matron.   The leftover-type of a matron is usually 116. A matron can be motherly or unmotherly. [The times-changed of a matron is usually 0. A matron has a number called potty-training. The potty-training of a matron is usually 0. A matron has a number called potty-training-asked. The potty-training-asked of a Matron is usually 0.][For planned future content]
...
To set up (M - a matron):
	...
	now M is hotel dwelling; [This allows her to respawn in the future.]
...
To compute sudden objectification of (M - a matron):
	say "The [M] puts a hand over her mouth in shock.  [speech style of M]'Oh dear darling, this just won't do.  You clearly need someone to take care of you...'[roman type][line break]".
...
To compute perception of (M - a matron):
	...
	otherwise if M is unfriendly:
		say "[one of]She seems compelled by her maternal instincts to care for her newest charge[or]She smiles warmly[if the delicateness of the player < 15], but with a small hint of malice[end if][stopping]. [speech style of M]'Hi, you naughty baby! You look like you need nanny's help.'[roman type][line break][if the diaper addiction of the player < 8]There's worry in your eyes as she approaches. She won't accept that you're really an adult and can care for your own self. [otherwise if the diaper addiction of the player > 15]You giggle and react with a whimsical [second custom style]'Ack!'[roman type] as you ready to play with your Nanny. [end if][if the delicateness of the player < 7]You hope you have the strength to fight her off. [otherwise if the delicateness of the player < 12]Your mind begins to wander thinking of what sort of humiliation she'll put you through, now.[otherwise if the delicateness of the player < 16]You yearn for her care.[otherwise]You ache to fall to your knees and let her do whatever she wants with your body.[end if]";
...
To say DragArrival of (M - a matron) to (R - Hotel22):
	...
	otherwise say "[one of][or][or][speech style of M]'[if there is a worn diaper]I should put you in a double diaper, that would keep you out of trouble.'[otherwise]You deserve a royal spanking, young miss!'[end if][roman type][line break][or][speech style of M]'Crawl faster!'[roman type][line break][in random order]".
...
To compute diaper change chastity cummies reward of (M - a matron):
	...
	diaperaddictup 1;
	say "The [M] pulls out slowly and gently.  [speech style of M]'If you keep being a good locked up [if the player is male]sissy[otherwise]baby[end if] for Nanny, you'll get more where that came from.'[roman type][line break]";
		...
		if the times-changed of M > 2 and (M is guardian or M is ally) and the player is incontinent and the potty-training of M is 0:
			if the potty-training-asked of M is 0:
				...
				otherwise if the player consents:
					say "Even though your brain says yes, your diaper loving heart screams 'NO'! You instinctively yell [second custom style]'No potty no potty!'[roman type] over and over, jumping up and down, just like a child throwing a tantrum. The matron smiles, patting your fresh diaper. [line break][speech style of M]'Don't worry, don't worry, I understand baby. You can wet [if diaper lover >= 3]and mess [end if]your diapers as much as you like.[roman type][line break]"; [Maybe have a diapered sex scene with matron here?]
					now the potty-training-asked of M is 1;
				otherwise:
...
This is the matron confiscates grown up items rule:
	...
	if the class of the player is adult baby:
		...
		if there is a worn necklace and a random number between 1 and 10 is 1 and the favour of M < 13:
			...
			say "The [M] notices your [C]!  [speech style of M]'Where did you get this, baby?!  This is my jewellery!  Bad [if the player is male]sissy[otherwise]girl[end if], this isn't yours to play with!  It's precious and delicate.  I'll be taking it back now.'[roman type][line break]  She pulls it off from your neck!";
...
To say SpankingAfterFlav of (M - a matron):
	say "The [M] puts you back down on the ground.  [speech style of M]'Now run along little one, but be on your best behaviour, understand?'[roman type][line break]The [M] visibly loses interest in you.".
...
To compute damage of (M - a matron):
	if the health of M > 0:
		if M is uninterested:
			say "She shrieks with shock.  [speech style of M]'[one of]How dare you!'[or]Do you never learn?!'[cycling][roman type][line break]";
			now M is interested;
			anger M;
		otherwise:
			if M is friendly:
...
To say DamageReaction (N - a number) of (M - a matron):
	if N > (the maxhealth of M / 4) * 3:
		say "[one of]'[speech style of M]You definitely deserve a punishment, you naughty harlot, you... Grr!'[roman type][line break][or]She sneers aggressively![stopping]";
