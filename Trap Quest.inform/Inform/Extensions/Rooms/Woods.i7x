...
*!]
Woods10 is a dodgy jungle room.  The printed name of Woods10 is "Statue Clearing".  "Right in the middle of this clearing is a statue of a man and woman having sex. [if a random vine boss is off-stage]The grass and trees here seems especially lush and vibrant.[otherwise]Thick green vines are draped over the man's shoulders, giving him the appearance of having a cape.[end if]".  The shape of Woods10 is L2/0-0-1-1-1-1.
