...
To reflect on (A - outrageous-gag):
	let G be a random ballgag worn by the player;
		...
		if N is 2:
			...
			otherwise if the old dexterity of the player < the flat dexterity of the player - 2:
				if the flat dexterity of the player < 7:
					say "[one of][variable custom style][line break]I'm still very stiff, but I can move a bit now.[roman type][line break][or][stopping]";
				otherwise if the flat dexterity of the player < 11:
					if the bimbo of the player < 7, say "[one of][first custom style][line break]I feel a bit less stiff now...[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]Ooh I feel a bit less stiff now.  I hope my flexibility comes back soon...[roman type][line break][or][stopping]";
				otherwise if the flat dexterity of the player < 15:
					if the bimbo of the player < 7, say "[one of][first custom style][line break]Hmm, I feel more limber!  That could be useful.[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I like feeling flexible![roman type][line break][or][stopping]";
				otherwise if the flat dexterity of the player < 19:
					if the bimbo of the player < 7, say "[one of][first custom style][line break]I feel fast![roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I can touch my toes without bending my knees![roman type][line break][or][stopping]";
				otherwise if the flat dexterity of the player < 23:
					if the bimbo of the player < 7, say "[one of][first custom style][line break]My hand eye coordination feels better than usual.[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I feel bouncy.  I think I can jump higher than before![roman type][line break][or][stopping]";
				otherwise:
					if the bimbo of the player < 11, say "[one of][first custom style][line break]I feel extremely fast![roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I'm so flexible I can touch my elbows together behind my back!  Oops, that just makes me push my chest out even more provocatively!  Tee hee![roman type][line break][or][stopping]";
				now the old dexterity of the player is the flat dexterity of the player;
				break;
			otherwise if the old dexterity of the player > the flat dexterity of the player + 2:
				if the flat dexterity of the player < 4:
					say "[one of][variable custom style][line break]I feel basically paralysed![roman type][line break][or][stopping]";
				otherwise if the flat dexterity of the player < 8:
					if the bimbo of the player < 8, say "[one of][first custom style][line break]My muscles feel very stiff now...[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I feel like I can hardly move![if the bimbo of the player > 10]  Maybe I shouldn't even bother trying to escape...[end if][roman type][line break][or][stopping]";
				otherwise if the flat dexterity of the player < 12:
					if the bimbo of the player < 8, say "[one of][first custom style][line break]I'm starting to feel pretty sluggish.[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I'm feeling pretty stiff, I might not be able to escape from anything![roman type][line break][or][stopping]";
				otherwise if the flat dexterity of the player < 16:
					if the bimbo of the player < 7, say "[one of][first custom style][line break]I feel less fast...[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I'm not feeling as flexible... I might not be able to escape from the [if the bimbo of the player < 9]scary [end if]traps![roman type][line break][or][stopping]";
				otherwise if the flat dexterity of the player < 20:
					if the bimbo of the player < 7, say "[one of][first custom style][line break]My hand eye coordination feels better than usual.[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I don't think I can jump really high any more.[if the largeness of breasts > 13]  Oh well, it still makes my boobs bounce around![end if][roman type][line break][or][stopping]";
				otherwise:
					if the bimbo of the player < 12, say "[one of][first custom style][line break]I feel less like a ninja now.[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]Aww, I'm not flexible enough to touch my elbows together in front of me any more.  Oops, that just makes me push my cleavage together even more provocatively!  Tee hee![roman type][line break][or][stopping]";
				now the old dexterity of the player is the flat dexterity of the player;
				break;
		if N is 3:
			...
			otherwise if the flat intelligence of the player < the old intelligence of the player - 2:
				if the flat intelligence of the player < 6:
					if the bimbo of the player < 12, say "[one of][first custom style][line break]The fog is starting to clear, I think?[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I think I can remember my name... Jessica?[roman type][line break][or][stopping]";
				otherwise if the flat intelligence of the player < 10:
					if the bimbo of the player < 14, say "[one of][first custom style][line break]I can think more clearly now![roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I feel smart, like I can spell big words!  F-E-L-L-A-T-I-O.  Fellatio!  Yaay![roman type][line break][or][stopping]";
				otherwise if the flat intelligence of the player < 14:
					if the bimbo of the player < 11, say "[one of][first custom style][line break]Incredible, it seems like the mind altering effects of this game can even affect my intelligence?  I feel smart.[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]Incredible, it seems like the mind altering effects of this game can even affect my intelligence, as well as my desire to suck [manly-penis].  I feel like a smart slut?  That could be okay...[roman type][line break][or][stopping]";
				otherwise if the flat intelligence of the player < 20:
					if the bimbo of the player < 13, say "[one of][first custom style][line break]I can do quadratic equations![roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]Facts are appearing in my head... did you know the average ejaculation has over 180 million sperm?  Yummy...[roman type][line break][or][stopping]";
				otherwise if the flat intelligence of the player < 25:
					if the bimbo of the player < 13, say "[one of][first custom style][line break]I know pi to ten-thousand places![roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]I feel like my brain is one half Einstein, one half Barbie![roman type][line break][or][stopping]";
				otherwise:
					if the bimbo of the player < 13, say "[one of][first custom style][line break]Hmm, I think I just solved chess.  That was easy.[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]Hmm, turns out that P = NP.  I can't believe I just did that in my head.  Though it'd be more fun if the P stood for Penis!  .  [roman type][line break][or][stopping]";
				now the old intelligence of the player is the flat intelligence of the player;
				break;
			otherwise if the flat intelligence of the player > the old intelligence of the player + 2:
				if the flat intelligence of the player < 3:
					if the bimbo of the player < 9, say "[one of][first custom style][line break]Can't... think... straight...[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]Keep trying to think about stuff, but, like, I just keep thinking about [manly-penis]s.. tee-hee![roman type][line break][or][stopping]";
				otherwise if the flat intelligence of the player < 6:
					if the bimbo of the player < 6, say "[one of][first custom style][line break]Ugh, I've got a bit of a headache.[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]What's Wal-Mart? Do they like make walls there?[roman type][line break][or][stopping]";
				otherwise if the flat intelligence of the player < 10:
					if the bimbo of the player < 7, say "[one of][first custom style][line break]Oh dear, I'm getting distracted more easily...[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]What was I thinking about again?  [if the largeness of breasts > 3]I keep getting distracted by my tits![end if][roman type][line break][or][stopping]";
				otherwise if the flat intelligence of the player < 15:
					if the bimbo of the player < 10, say "[one of][first custom style][line break]What happened to my new intelligence?  It's disappearing again...[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]Sex is way more fun than sums![roman type][line break][or][stopping]";
				otherwise:
					if the bimbo of the player < 15, say "[one of][first custom style][line break]The urge to do maths in my head is fading...[roman type][line break][or][stopping]";
					otherwise say "[one of][second custom style][line break]Aww, there was some cool fact about sex I was just thinking about, but now I can't remember it...[roman type][line break][or][stopping]";
				now the old intelligence of the player is the flat intelligence of the player;
				break.
