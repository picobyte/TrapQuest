...
To check for arousal change:
	...
	if P < previous-horny:
		...
		if previous-horny is 2:
			...
			if the living belt of sturdiness is worn and the player is not prone, say "[one of]Suddenly[or]Once again[stopping] the tentacle[if the living belt of sturdiness is penetrating asshole and the living belt of sturdiness is penetrating vagina]s[end if] of the [printed name of the living belt of sturdiness] inside of you start[unless the living belt of sturdiness is penetrating asshole and the living belt of sturdiness is penetrating vagina]s[end if] moving, slowly thrusting all the way in and all the way out.[one of]  The thrusting is strong and deliberate but incredibly slow, as if its purpose is to very very slowly build you up to a very powerful orgasm.[or][stopping]";
		if previous-horny is 3:
			say "[bold type]You now feel desperately horny.  You are having an even harder time thinking about anything non-sexual[if the bimbo of the player > 8][second custom style][one of] (Tee-hee, hard)[bold type][or][stopping][end if] - [if diaper quest is 1]your intelligence is significantly reduced until you orgasm or cool off.[otherwise if there is an unfriendly monster penetrating a fuckhole and the sex addiction of the player < 8]you might struggle to bring yourself to properly resist now.[otherwise if the sex addiction of the player < 12]it's going to be a lot more difficult to say no to the advances of others now![otherwise]once there's a [manly-penis] inside you, there's no way you're going to be anything but a willing fuckhole until you get off.[end if][roman type][line break]";
